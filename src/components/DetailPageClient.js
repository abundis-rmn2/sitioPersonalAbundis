  ...
  return (
    <motion.div initial="initial" animate="animate" exit="exit" variants={pageVariants}>
      ...
      <section className="list-Template" style={{ position: 'relative', zIndex: 10 }}>
        ...
        {tData.citation && (
          <div 
            style={{ display: 'block', padding: '1rem', borderLeft: '3px solid var(--color-principal)', background: '#fcfcfc', marginBottom: '1.5rem', fontSize: '0.95rem', lineHeight: '1.5', color: '#555' }}
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', background: 'transparent' }}>
          {post.project_url && (
